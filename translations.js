const translations = {
    ko: {
        ...
        'core-insight-label': '통합 건강 제언',
        'core-insight-Taeyangin': '태양인은 기운이 위로 솟구치기 쉬우므로, 하체를 단련하고 마음을 차분하게 가라앉히는 운동이 좋습니다.',
        'core-insight-Taeeumin': '태음인은 노폐물이 쌓이기 쉬운 체질이므로, 땀을 흠뻑 흘리는 고강도 유산소 운동이 필수적입니다.',
        'core-insight-Soyangin': '소양인은 상체는 발달했으나 하체가 약할 수 있으므로, 하체 근력을 강화하는 웨이트 트레이닝을 추천합니다.',
        'core-insight-Soeumin': '소음인은 체력이 약해지기 쉬우므로, 무리한 운동보다는 꾸준한 저강도 근력 운동과 스트레칭이 효과적입니다.',
    ...
    en: {
        ...
        'core-insight-Taeyangin': 'Taeyangin types should focus on lower body strength and calming exercises.',
        'core-insight-Taeeumin': 'Taeeumin types need high-intensity cardio to sweat out toxins.',
        'core-insight-Soyangin': 'Soyangin types should focus on leg strengthening weight training.',
        'core-insight-Soeumin': 'Soeumin types should prefer consistent low-intensity workouts and stretching.',
        'magazine-title': 'Health & Wisdom Magazine',
